...
export class ImportarComponent implements OnInit {
  ...
  constructor(
    ...
    private reincorporacionService: ReincorporacionService,
  ...
  cargarArchivo()
  {
    ...
    /*this.reincorporacionService.cargaArchivo({ tipo:this.tipoformato }).subscribe(
      response => {
        this.isLoading = false;
  ...
  validarInformacion()
  {
    ...
    /*this.reincorporacionService.validarComisiones({ tipo: this.tipoformato }).subscribe(
      response => {
        this.isLoading = false;
  ...
  importar()
  {
    /*this.reincorporacionService.importarComisiones({ tipo: this.tipoformato }).subscribe(
      response => {
