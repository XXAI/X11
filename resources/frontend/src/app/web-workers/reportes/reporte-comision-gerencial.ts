...
export class ReporteComisionGerencial {
  ...
  getDocumentDefinition(reportData:any) {
    ...
    data.forEach(element => {
      ...
      contenido += "Asimismo se le informa que al término de la presente comisión, deberá reincorporarse a la unidad de su adscripción como lo establece el artículo 151 de las Condiciones Generales de Trabajo.\n\n";
