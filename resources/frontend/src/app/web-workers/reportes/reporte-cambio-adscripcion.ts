...
export class ReporteTrabajadorCambioAdscripcion {
  ...
  getDocumentDefinition(reportData:any) {
    ...
    data.forEach(element => {
      ...
      let comision_inicio = element.rel_trabajador_adscripcion;
      let mes_inicio = (parseInt(comision_inicio.fecha_cambio.substr(5,2)) - 1);
      let mes_fin = 1;//(parseInt(comision_inicio.fecha_fin.substr(5,2)) - 1);

      let fecha_inicio =  new Intl.DateTimeFormat('es-ES', {year: 'numeric', month: 'long', day: '2-digit'}).format(new Date(comision_inicio.fecha_cambio.substr(0,4), mes_inicio,comision_inicio.fecha_cambio.substr(8,2)));
      let fecha_fin =  new Intl.DateTimeFormat('es-ES', {year: 'numeric', month: 'long', day: '2-digit'}).format(new Date(comision_inicio.fecha_cambio.substr(0,4), mes_fin,comision_inicio.fecha_cambio.substr(8,2)));
      ...
      let comision = element.rel_trabajador_adscripcion;
      ...
      {
        destino = "( "+comision.cr_destino.clues.clasificacion+") "+comision.cr_destino.descripcion_actualizada+" "+comision.cr_destino.clues.clues+", con domicilio ubicado en "+comision.cr_destino.direccion;
      ...
      //if(comision.cr_origen.dependencia.cr == comision.cr_destino.dependencia.cr)
      //{
        dato_origen = "";
      //}
