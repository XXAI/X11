  ...
  getDocumentDefinition(reportData:any) {
    ...
    data.forEach(element => {
      ...
      switch (datos_nominales.ur) {
        ...
        case "FO3": 
        case "FOR": 
          acuse_qr = "Atento a lo anterior, con fundamento en el artículo 134 de la Ley Federal del Trabajo, 52 fracciones I, III, VI y XI y 53 de la Ley del Servicios Civil del Estado y los Municipios de Chiapas, 82, 133, 134 y demás relativos aplicables de las Condiciones Generales del Trabajo, por las necesidades del servicio y para los efectos de garantizar la demanda de atención médica que la población requiere de los servicios de salud; tengo a bien comunicarle a usted, que a partir "+periodo+", queda comisionado a "+destino+"; "+clave+" con código funcional de "+datos_nominales.codigo.descripcion+" "+datos_nominales.codigo_puesto_id+" , por lo que deberá presentarse con el/la  "+responsable+", en un horario de 08:00 a las 15:00 horas, quien le indicará las actividades, horario y funciones a ejecutar.";
          contenido += acuse_qr+"\n\n";
        ...
        break;
        default:
          acuse_qr ="Atento a lo anterior, con fundamento en el artículo 134 de la Ley Federal del Trabajo, 52 fracciones I, III, VI y XI y 53 de la Ley del Servicios Civil del Estado y los Municipios de Chiapas, así como de la CLÁUSULA QUINTA del Contrato Individual de Trabajo por tiempo determinado de fecha primero de enero del año "+anio_actual+", por las necesidades del servicio y para los efectos de garantizar la demanda de atención médica que la población requiere de los servicios de salud; tengo a bien comunicarle a usted, que a partir "+periodo+", queda comisionado a "+destino+"; con código funcional de "+datos_nominales.codigo.descripcion+" "+datos_nominales.codigo_puesto_id+", por lo que deberá presentarse con el/la  "+responsable+", en un horario de 08:00 a las 15:00 horas, quien le indicará las actividades, horario y funciones a ejecutar.";
          contenido += acuse_qr+"\n\n";
