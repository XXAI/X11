        ...
        try{
            ...
            $obj = DB::TABLE("trabajador as t")
                ...
                ->select(
                    ...
                    DB::RAW("(SELECT IF(count(`catalogo_profesion`.`descripcion`) > 0, `catalogo_profesion`.`descripcion`, (SELECT `rel_trabajador_escolaridad`.`otro_nombre_estudio` FROM   `rel_trabajador_escolaridad` WHERE  `rel_trabajador_escolaridad`.`grado_academico_id` = 2039852 AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1)) FROM   `catalogo_profesion` WHERE  `catalogo_profesion`.`clave_sinergias` = (SELECT `rel_trabajador_escolaridad`.`nombre_estudio_id` FROM `rel_trabajador_escolaridad` WHERE `rel_trabajador_escolaridad`.`grado_academico_id` = 2039852 AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1)) AS `maestria`"),
                    ...
                    DB::RAW("(SELECT IF(count(`catalogo_profesion`.`descripcion`) > 0, `catalogo_profesion`.`descripcion`, (SELECT `rel_trabajador_escolaridad`.`otro_nombre_estudio` FROM   `rel_trabajador_escolaridad` WHERE  `rel_trabajador_escolaridad`.`grado_academico_id` = 2039853 AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1)) FROM   `catalogo_profesion` WHERE  `catalogo_profesion`.`clave_sinergias` = (SELECT `rel_trabajador_escolaridad`.`nombre_estudio_id` FROM `rel_trabajador_escolaridad` WHERE `rel_trabajador_escolaridad`.`grado_academico_id` = 2039853 AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1)) AS `doctorado`"),
                    ...
                    DB::RAW("(SELECT IF(count(`catalogo_profesion`.`descripcion`) > 0, `catalogo_profesion`.`descripcion`, (SELECT `rel_trabajador_escolaridad`.`otro_nombre_estudio` FROM   `rel_trabajador_escolaridad` WHERE  `rel_trabajador_escolaridad`.`grado_academico_id` IN ( 2039854, 2039856 ) AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1)) FROM   `catalogo_profesion` WHERE  `catalogo_profesion`.`clave_sinergias` = (SELECT `rel_trabajador_escolaridad`.`nombre_estudio_id` FROM `rel_trabajador_escolaridad` WHERE `rel_trabajador_escolaridad`.`grado_academico_id` IN ( 2039854, 2039856 ) AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1)) AS `especialidad`"),
                    DB::RAW("(SELECT `rel_trabajador_escolaridad`.`no_cedula` FROM   `rel_trabajador_escolaridad` WHERE  `rel_trabajador_escolaridad`.`grado_academico_id` IN ( 2039854, 2039856 ) AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1) AS `especialidad_cedula`"),
                    DB::RAW("(SELECT IF(count(`catalogo_profesion`.`descripcion`) > 0, `catalogo_profesion`.`descripcion`, (SELECT `rel_trabajador_escolaridad`.`otro_nombre_estudio` FROM   `rel_trabajador_escolaridad` WHERE  `rel_trabajador_escolaridad`.`grado_academico_id` IN ( 2039849, 2039850 ) AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1)) FROM   `catalogo_profesion` WHERE  `catalogo_profesion`.`clave_sinergias` = (SELECT `rel_trabajador_escolaridad`.`nombre_estudio_id` FROM `rel_trabajador_escolaridad` WHERE `rel_trabajador_escolaridad`.`grado_academico_id` IN ( 2039849, 2039850 ) AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1)) AS `tecnica`"),
                    DB::RAW("(SELECT `rel_trabajador_escolaridad`.`no_cedula` FROM   `rel_trabajador_escolaridad` WHERE  `rel_trabajador_escolaridad`.`grado_academico_id` IN ( 2039849, 2039850 ) AND `rel_trabajador_escolaridad`.`trabajador_id` = `t`.`id` AND `rel_trabajador_escolaridad`.`deleted_at` IS NULL LIMIT  1) AS `tecnica_cedula`"),
